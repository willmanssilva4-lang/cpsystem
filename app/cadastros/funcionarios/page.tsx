    ...
    <div className="p-8 space-y-8 bg-white min-h-screen">
      <div className="flex items-center gap-4">
        ...
        <div className="flex flex-col gap-1">
          <h1 className="text-3xl font-black tracking-tight text-brand-text-main italic uppercase">Funcionários</h1>
          <p className="text-brand-blue/60 font-medium">Cadastro de equipe e permissões.</p>
        </div>
      </div>
