      ...
      <AnimatePresence mode="wait">
        {step === 1 && (
          <motion.div
            ...
            className="max-w-4xl"
          >
            <div className="p-12 border-4 border-dashed border-brand-border rounded-[48px] bg-slate-50/30 flex flex-col items-center justify-center text-center space-y-6 hover:border-brand-border transition-all">
          ...
          >
                ...
                <tbody className="divide-y divide-slate-50">
                  {[
                    ...
                    <tr key={prod.id} className="hover:bg-slate-50/30 transition-colors">
                      ...
                      <td className="px-6 py-4 text-sm font-bold text-brand-text-main">{prod.qty}</td>
                      <td className="px-6 py-4 text-xs font-black text-brand-text-main/40">{prod.un}</td>
                      <td className="px-6 py-4 text-sm font-bold text-brand-text-main">{prod.unit}</td>
            ...
            <div className="flex items-center justify-between p-8 bg-brand-text-main rounded-[32px] text-white">
              ...
              <div className="flex items-center gap-4">
                ...
                <button 
                  onClick={() => setStep(3)}
                  className="px-8 py-4 bg-brand-blue-hover text-white rounded-2xl font-black uppercase italic tracking-tight shadow-xl shadow-brand-blue-hover/20 hover:bg-brand-text-sec transition-all"
                >
                  Confirmar Entrada
                </button>
              </div>
